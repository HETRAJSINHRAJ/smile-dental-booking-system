  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Reschedule Appointment (Admin)</DialogTitle>
          <DialogDescription>
            Select a new date and time for this appointment. Admins can reschedule without limits.
          </DialogDescription>
        </DialogHeader>
