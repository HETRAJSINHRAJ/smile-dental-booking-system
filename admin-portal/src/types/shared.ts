...
export type WaitlistStatus = 'active' | 'notified' | 'expired' | 'booked' | 'cancelled';
...
export interface Waitlist {
  ...
  preferredTime: string; // HH:mm format or time range like "09:00-12:00"
  status: WaitlistStatus;
  
  // Notification tracking
  notifiedAt?: Timestamp;
  notificationSent?: boolean;
  expiresAt?: Timestamp; // 24 hours after notification
