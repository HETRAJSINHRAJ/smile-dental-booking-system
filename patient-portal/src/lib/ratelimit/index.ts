...
/**
 * Log rate limit violation (simplified version without audit logger)
 */
export async function logRateLimitViolation(
  ...
  console.warn(`Rate limit exceeded: ${type} endpoint ${endpoint} by ${identifier} from IP ${ipAddress}`);
}
